...
// DirectionalDiagram.cpp: определяет поведение классов для приложения.
//
...
// CDirectionalDiagramApp

BEGIN_MESSAGE_MAP(CDirectionalDiagramApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDirectionalDiagramApp

CDirectionalDiagramApp::CDirectionalDiagramApp()
{
...
// Единственный объект CDirectionalDiagramApp

CDirectionalDiagramApp theApp;


// Инициализация CDirectionalDiagramApp

BOOL CDirectionalDiagramApp::InitInstance()
{
